                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="breadcrumbs-box">
                                    <ul>
                                        ...
                                        <li class="final">
                                            <span>{{ trans('message.anh') }}</span>
                                            <h2 style="display:none">{{ trans('message.anh') }}</h2>
										</li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="banners-content">
                                <ul class="banners-box images-grid grid grid-3">
                                            ...
                                            <div class="banner-box">
                                                ...
                                                <div class="banner-content">
                                                    <div class="banner-name">
                                                        <a href="#" class="banner-link" title="{{ app()->getLocale() == 'vi' ? $item->name : $item->name_en }}">{{ app()->getLocale() == 'vi' ? $item->name : $item->name_en }}</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </li>
...
@section('script')
	<script>
        ...
        $(document).ready(function($) {
			$('body').addClass('page-body anh-body');
		});
	</script>
@endsection