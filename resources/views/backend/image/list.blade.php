    ...
    <div class="content">
        ...
        <div class="box box-primary">
            <div class="box-body">
                ...
                <form action="{{ route('images.postMultiDel') }}" method="POST">
                    @csrf
                    <div class="btnAdd">
                        <a href="{{ route('images.create') }}?type={{ request()->get('type') }}">
                        ...
                        <tbody>
                            @foreach ($data as $item)
                                <tr>
                                    ...
                                    <td>
                                    <div>
                                        <a href="{{ route('images.edit', ['id'=> $item->id, 'type' => $item->type]) }}" title="Sửa">
                                            <i class="fa fa-pencil fa-fw"></i> Sửa
                                        </a> &nbsp; &nbsp; &nbsp;
                                          <a href="javascript:void(0);" class="btn-destroy" 
                                          data-href="{{ route( 'images.destroy',  $item->id ) }}"
